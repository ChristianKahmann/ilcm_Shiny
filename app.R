...
source("www/ilcm_dashboard_theme_deval.R")
...
if(look=="fancy"){
  ...
  #navbarstyle="paper"
  dashboardstyle=ilcm_dashboard_theme
  #dashboardstyle=NULL
}
if(look=="scientific"){
...
ui <- dashboardPage(
  ...
  dashboardSidebar(width="200px",
                   sidebarMenu(id = "tabs",
                               ...
                               menuItem(text=  "Importer",tabName= "Importer",icon=icon("upload")),
                               tags$a("DEVal",id="deval_link", target="_blank", href="https://www.deval.org/"),
  ...
  dashboardBody(
conditionalPanel(condition="input.pw=='Augustusplatz04109'",  
  dashboardstyle,
    shinyjs::useShinyjs(),
    ...
    tabItems(
      tabItem(tabName = "Explorer",
              column(width=10,
                     div(style = 'height: 92vh; overflow-y: hidden; overflow-x:hidden;',
                         box(width = NULL,
              ...
              column(width=2,
                     div(style = 'height: 92vh; overflow-y: auto; overflow-x:hidden;',
      ...
      tabItem(tabName="Importer",
              div(style = 'height: 92vh; overflow-y: auto; overflow-x: auto;',
                  navbarPage(title = "Importer",id = "import",
...
title="Passwort eingeben",easyClose = F,
    passwordInput(inputId = "pw",label = "Passwort:")
  ))
 
  source(file.path("server","System_Load_Menu.R"),local = T)$value
  source(file.path("server","tab_Choose_Collection.R"),local = T)$value
