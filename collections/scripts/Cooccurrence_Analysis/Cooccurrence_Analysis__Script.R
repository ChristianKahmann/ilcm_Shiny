...
error<-try(expr = {
  ...
  log_to_file(message = "finished calculating coocs with Dice-Significance measure",logfile)
  gc()
  coocsCalc$set_measure("MI")
  coocs_matrix_mi<-coocsCalc$ccoocs()
  log_to_file(message = "finished calculating coocs with Mutual Information measure",logfile)
  gc()
  coocsCalc$set_measure("LOGLIK")
  coocs_matrix_log<-coocsCalc$ccoocs()
  log_to_file(message = "finished calculating coocs with Log-likelihood measure",logfile)
