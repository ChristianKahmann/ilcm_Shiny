# decission trees work well when it comes to deciding between 2 classes 
# with more than 2 classes the decission tree turns into a random forest

############################################
#           learning example               #
############################################
#' create 50 active learning sample for choosen class - decissionTree mode
...
#' WARNING: Just works with enough annotations for the selected class
...
###########
  ...
  # uses randomForest for validation
  # random Forest decides differently each iteration (even though values of c are irrelevant)
...
####
  #will only be able to find important variables(features) if there are enough pre labled data
