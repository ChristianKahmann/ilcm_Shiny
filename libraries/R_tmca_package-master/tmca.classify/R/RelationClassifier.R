...
############################################################################################################################
#' An Abstraction 'base class' for  Relation classification algorithms and active learning.
#'
...
#' }
#'
RelationClassifier_abstr <- R6Class(
  "classifier_abstr",
  private = list(
    name = "",
    package = "",
...
####################################################################################
#' Implementation of Convolutional-RE algorithm \cite{paper}
#' 
...
Conv_RE_model <- R6Class(
  "Conv_RE_model",
  inherit = classifier_abstr,
  private = list(
    name = "model",
    package = "Conv_RE_model",
    parameters = list(
      cost = 0.1, 
      epsilon = 0.01, 
      bias = 1,
...
classify.register = list("tmca_classify::Conv_RE_model" = Conv_RE_model
)
