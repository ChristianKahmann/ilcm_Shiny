...
#'
#' @param j Which fold to select
#' @param k size of folds
#' @param n soze of training data
#'
#' @return The current data selection for i
#' @export
#'
#' @examples
...
k_fold_cross_validation <- function(labeledDTM, classesOfDocuments, k = 10, svmC = 1, ...) {
