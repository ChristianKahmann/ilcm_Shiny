...
output$Det_Senti_validation_UI<-renderUI({
  ...
  title_score<-values$Det_Senti_meta[intersect(which(values$Det_Senti_meta[,"dataset"]==dataset),which(values$Det_Senti_meta[,"id_doc"]==input$Det_SA_validation_document)),c("title","scores")]
  ######################
  text<-values$Det_Senti_meta$text[which(values$Det_Senti_meta$id_doc==paste0(dataset,"_",doc_id))]
