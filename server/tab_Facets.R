...
output$Fac_mde1_abs<-renderUI({
  ...
  plot_output_list <- lapply(1:1, function(i) {
    ...
    plot_output_object <- renderPlotly({
      ...
      p<-layout(p,title=paste(values$facet_names[1]," (absolute)"),yaxis=list(type="category",categoryorder="trace"),margin=list(l=left_margin,t=50),xaxis=list(side="top"))
...
output$Fac_mde1_rel<-renderUI({
  ...
  plot_output_list <- lapply(1:1, function(i) {
    ...
    plot_output_object <- renderPlotly({
      ...
      p<-layout(p,title=paste(values$facet_names[1]," (relative)"),yaxis=list(type="category",categoryorder="trace"),margin=list(l=left_margin,t=50),xaxis=list(side="top"))
      p<-plotly::config(p,displayModeBar=FALSE)
      return(p)
    })
  })
...
output$Fac_mde2_abs<-renderUI({
  ...
  plot_output_list <- lapply(1:1, function(i) {
    ...
    plot_output_object <- renderPlotly({
      ...
      p<-layout(p,title=paste(values$facet_names[2]," (absolute)"),yaxis=list(type="category",categoryorder="trace"),margin=list(l=150,t=50),xaxis=list(side="top"))
      p<-plotly::config(p,displayModeBar=FALSE)
      return(p)
    })
  })
...
output$Fac_mde2_rel<-renderUI({
  ...
  plot_output_list <- lapply(1:1, function(i) {
    ...
    plot_output_object <- renderPlotly({
      ...
      p<-layout(p,title=paste(values$facet_names[2]," (relative)"),yaxis=list(type="category",categoryorder="trace"),margin=list(l=150,t=50),xaxis=list(side="top"))
      p<-plotly::config(p,displayModeBar=FALSE)
      return(p)
    })
  })
...
output$Fac_mde3_abs<-renderUI({
  ...
  plot_output_list <- lapply(1:1, function(i) {
    ...
    plot_output_object <- renderPlotly({
      ...
      p<-layout(p,title=paste(values$facet_names[3]," (absolute)"),yaxis=list(type="category",categoryorder="trace"),margin=list(l=150,t=50),xaxis=list(side="top"))
      p<-plotly::config(p,displayModeBar=FALSE)
      return(p)
    })
  })
...
output$Fac_mde3_rel<-renderUI({
  ...
  plot_output_list <- lapply(1:1, function(i) {
    ...
    plot_output_object <- renderPlotly({
      ...
      p<-layout(p,title=paste(values$facet_names[3]," (relative)"),yaxis=list(type="category",categoryorder="trace"),margin=list(l=150,t=50),xaxis=list(side="top"))
      p<-plotly::config(p,displayModeBar=FALSE)
      return(p)
    })
  })
...
output$Fac_mde4_abs<-renderUI({
  ...
  plot_output_list <- lapply(1:1, function(i) {
    ...
    plot_output_object <- renderPlotly({
      ...
      p<-layout(p,title=paste(values$facet_names[4]," (absolute)"),yaxis=list(type="category",categoryorder="trace"),margin=list(l=150,t=50),xaxis=list(side="top"))
      p<-plotly::config(p,displayModeBar=FALSE)
      return(p)
    })
  })
...
output$Fac_mde4_rel<-renderUI({
  ...
  plot_output_list <- lapply(1:1, function(i) {
    ...
    plot_output_object <- renderPlotly({
      ...
      p<-layout(p,title=paste(values$facet_names[4]," (relative)"),yaxis=list(type="category",categoryorder="trace"),margin=list(l=150,t=50),xaxis=list(side="top"))
      p<-plotly::config(p,displayModeBar=FALSE)
      return(p)
    })
  })
...
output$Fac_mde5_abs<-renderUI({
  ...
  plot_output_list <- lapply(1:1, function(i) {
    ...
    plot_output_object <- renderPlotly({
      ...
      p<-layout(p,title=paste(values$facet_names[5]," (absolute)"),yaxis=list(type="category",categoryorder="trace"),margin=list(l=150,t=50),xaxis=list(side="top"))
      p<-plotly::config(p,displayModeBar=FALSE)
      return(p)
    })
  })
...
output$Fac_mde5_rel<-renderUI({
  ...
  plot_output_list <- lapply(1:1, function(i) {
    ...
    plot_output_object <- renderPlotly({
      ...
      p<-layout(p,title=paste(values$facet_names[5]," (relative)"),yaxis=list(type="category",categoryorder="trace"),margin=list(l=150,t=50),xaxis=list(side="top"))
      p<-plotly::config(p,displayModeBar=FALSE)
      return(p)
    })
  })
...
output$Fac_mde6_abs<-renderUI({
  ...
  plot_output_list <- lapply(1:1, function(i) {
    ...
    plot_output_object <- renderPlotly({
      ...
      p<-layout(p,title=paste(values$facet_names[6]," (absolute)"),yaxis=list(type="category",categoryorder="trace"),margin=list(l=150,t=50),xaxis=list(side="top"))
      p<-plotly::config(p,displayModeBar=FALSE)
      return(p)
    })
  })
...
output$Fac_mde6_rel<-renderUI({
  ...
  plot_output_list <- lapply(1:1, function(i) {
    ...
    plot_output_object <- renderPlotly({
      ...
      p<-layout(p,title=paste(values$facet_names[6]," (relative)"),yaxis=list(type="category",categoryorder="trace"),margin=list(l=150,t=50),xaxis=list(side="top"))
      p<-plotly::config(p,displayModeBar=FALSE)
      return(p)
    })
  })
...
output$Fac_mde7_abs<-renderUI({
  ...
  plot_output_list <- lapply(1:1, function(i) {
    ...
    plot_output_object <- renderPlotly({
      ...
      p<-layout(p,title=paste(values$facet_names[7]," (absolute)"),yaxis=list(type="category",categoryorder="trace"),margin=list(l=150,t=50),xaxis=list(side="top"))
      p<-plotly::config(p,displayModeBar=FALSE)
      return(p)
    })
  })
...
output$Fac_mde7_rel<-renderUI({
  ...
  plot_output_list <- lapply(1:1, function(i) {
    ...
    plot_output_object <- renderPlotly({
      ...
      p<-layout(p,title=paste(values$facet_names[7]," (relative)"),yaxis=list(type="category",categoryorder="trace"),margin=list(l=150,t=50),xaxis=list(side="top"))
      p<-plotly::config(p,displayModeBar=FALSE)
      return(p)
    })
  })
...
output$Fac_mde8_abs<-renderUI({
  ...
  plot_output_list <- lapply(1:1, function(i) {
    ...
    plot_output_object <- renderPlotly({
      ...
      p<-layout(p,title=paste(values$facet_names[8]," (absolute)"),yaxis=list(type="category",categoryorder="trace"),margin=list(l=150,t=50),xaxis=list(side="top"))
      p<-plotly::config(p,displayModeBar=FALSE)
      return(p)
    })
  })
...
output$Fac_mde8_rel<-renderUI({
  ...
  plot_output_list <- lapply(1:1, function(i) {
    ...
    plot_output_object <- renderPlotly({
      ...
      p<-layout(p,title=paste(values$facet_names[8]," (relative)"),yaxis=list(type="category",categoryorder="trace"),margin=list(l=150,t=50),xaxis=list(side="top"))
      p<-plotly::config(p,displayModeBar=FALSE)
      return(p)
    })
  })
...
output$Fac_mde9_abs<-renderUI({
  ...
  plot_output_list <- lapply(1:1, function(i) {
    ...
    plot_output_object <- renderPlotly({
      ...
      p<-layout(p,title=paste(values$facet_names[9]," (absolute)"),yaxis=list(type="category",categoryorder="trace"),margin=list(l=150,t=50),xaxis=list(side="top"))
      p<-plotly::config(p,displayModeBar=FALSE)
      return(p)
    })
  })
...
output$Fac_mde9_rel<-renderUI({
  ...
  plot_output_list <- lapply(1:1, function(i) {
    ...
    plot_output_object <- renderPlotly({
      ...
      p<-layout(p,title=paste(values$facet_names[9]," (relative)"),yaxis=list(type="category",categoryorder="trace"),margin=list(l=150,t=50),xaxis=list(side="top"))
      p<-plotly::config(p,displayModeBar=FALSE)
      return(p)
    })
  })
...
output$Fac_Entities_abs<-renderUI({
  ...
  plot_output_list <- lapply(1:1, function(i) {
    ...
    plot_output_object <- renderPlotly({
      ...
      p<-layout(p,title="Entities (absolute)",yaxis=list(type="category",categoryorder="trace"),margin=list(l=100,t=50),xaxis=list(side="top"))
      p<-plotly::config(p,displayModeBar=FALSE)
      return(p)
    })
  })
...
output$Fac_Entities_rel<-renderUI({
  ...
  plot_output_list <- lapply(1:1, function(i) {
    ...
    plot_output_object <- renderPlotly({
      ...
      p<-layout(p,title="Entities (relative)",yaxis=list(type="category",categoryorder="trace"),margin=list(l=100,t=50),xaxis=list(side="top"))
      p<-plotly::config(p,displayModeBar=FALSE)
      return(p)
    })
  })
