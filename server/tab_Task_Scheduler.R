...
observeEvent(input$analysis_help,ignoreInit = T,{
  ...
  if(file.exists(path_to_tutorial)){
    ...
    shinyalert::shinyalert(title = "No Tutorial found",text = "For your chosen analysis, there is no tutorial .md file located in the tutorials dictionary. Sorry!",type = "warning")
  }
