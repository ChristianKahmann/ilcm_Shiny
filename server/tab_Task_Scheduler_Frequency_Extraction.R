...
#'   input$FE_baseform: should words be reduced their baseform
...
#'   input$FE_remove_hyphenation: shoult hyphenation be removed?
...
#'   input$FE_ENTITY_TYPES: select entity (NER) types that shouldbe used
